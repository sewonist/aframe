...
architecture](https://aframe.io/docs/1.2.1/introduction/entity-component-system.html), we can drop in community
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/aframe-gradient-sky@1.2.1/dist/gradientsky.min.js"></script>
  </head>
  <body>
    <a-scene>
...
To use the latest stable build of A-Frame, include [`aframe.min.js`](https://aframe.io/releases/1.2.1/aframe.min.js):
